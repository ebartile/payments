...
<head>
        ...
        <title> Deposit via Scratch cards </title>
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          ...
          <legend>Deposit via scratch cards</legend>
...
<div class="validation-summary-valid" data-valmsg-summary="true"><ul><li style="display:none"></li>
	...
	<hr>   
					...
					<form action="php/process_card.php" method="POST" name="login_form">
					    <div class="form-group row">
	<div class="column medium-6">
		<label for="buyerPassword" class="control-label">Enter the 10 digit code here<span class="field-validation-valid" data-valmsg-for="password" data-valmsg-replace="false">*</span></label>
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-lock"></i></span>
		 <input type="text" name="code" id="code" placeholder="Enter the 10 digit code here" required>
	   </div>
