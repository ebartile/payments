...
<head>
        ...
        <title>Agent Deposit - Payment Gateway</title>
...
<form  class="form-horizontal" action="php/process_Agentdeposits.php" method="POST" name="login_form">
