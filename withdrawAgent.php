...
<head>
        ...
        <title>Agent Withdraw - Payment Gateway</title>
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          ...
          <legend>Agent Withdrawal</legend>
...
<form  class="form-horizontal" action="php/process_Agentwithdrawals.php" method="POST" name="login_form">



<div class="form-group">
	<label class="control-label" for="buyerEmail">Agent number:<span class="field-validation-valid" data-valmsg-for="email" data-valmsg-replace="false">*</span></label>
	<div class="controls input-group">
		<span class="input-group-label"><i class="pe-7s-mail"></i></span>
	<input type="text" name="agent_number"  required>
	</div>
</div>
