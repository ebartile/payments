...
<div class="form-group">
	<label class="control-label" for="buyerEmail">Retrieval code <span class="field-validation-valid" data-valmsg-for="email" data-valmsg-replace="false">*</span></label>
	<div class="controls input-group">
		<span class="input-group-label"><i class="pe-7s-mail"></i></span>
		<input class="input-block-level input-large" id="buyerEmail" name="code" placeholder="Retrieval code" maxlength="5" minlength= "5" type="text" required/> 
	</div>
</div>

<div class="form-group">
	<div class="controls input-group">
		<input type="submit" value="Proceed" name="final" class="button alert"/>
	</div>
</div>
</form>
<?php
