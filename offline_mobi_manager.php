...
<head>
        ...
        <title>Offline mobile Wallets Methods Manager</title>
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          <legend>Offline mobile Wallets Methods manager</br>
					</legend>
		...
		?>	
				...
				<table style="width:100%;">
											...
											<tr>
												...
												<th>Allowed?</th>
												<th> <button onclick="openForm()" class="button alert">Add a MOBI</button></th>
...
$sqluser = "SELECT * FROM offline_MOBI ORDER BY id DESC";
...
if ($resultuser->num_rows > 0) {
    ...
    while($row = $resultuser->fetch_assoc()) {
        ...
        echo
											'<tr>
													<td><a href="admin_mobiDetails.php?code=XlAPCHF526628GSHAJ'.$row['id'].'">'.$row['MOBI_name'].'</a></td>
													
													<td><span style="color:#2B547E;">' .$row['mobi_number']. '</span>  </td>
													...
													<td>'.$row['allowed'].'</td>
														...
														<td><button class="button primary"><a href="admin_mobiDetails.php?code=XlAPCHF526628GSHAJ'.$row['id'].'">Edit</a></button></td>
												</tr>';
...
<?php require_once "inc/footer.php"; ?>
  ...
  <form action="php/add_mobi.php" class="form-container" method="POST">
      <button type="button" class="btn cancel" onclick="closeForm()">Close form </button>
    <p>You are now adding a new MOBI Wallet Method</p>

    <label for="mobi_name"><b>MOBI Name</b></label>
    <input type="text" placeholder="Enter MOBI Name" name="mobi_name" required>
    ...
    <button type="submit" class="btn" name="submitcard">Submit this MOBI Wallet Method</button>
