...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo
											...
											<td><a href="edit_mailSettings.php" class="button special small fit">Edit Mail Params</a></td></tr>
											<tr>
												...
												<tr>
													<td>Support email: <a href="#">'.$row['support_email'] . '</a></td>
													...
													<tr>
													<td>No-Reply email: <a href="#">'.$row['no_replt'] . '</a></td>
													...
													<tr>
													<td>Gateway url: <a href="#">'.$row['site_url'] . '</a></td>
													...
													<tr>
													<td>Mailer subject: <a href="#">'.$row['mailer_subject'] . '</a></td>
											...
											<td><a href="edit_mailSettings.php" class="button special small fit">Edit Mailer Params</a></td></tr>
