...
sec_session_start();
 ...
 $sql = "SELECT * FROM mpesa_c2b_settings WHERE id = 1";
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          ...
          <legend>Lipa na Mpesa Deposit</legend>
...
<div class="validation-summary-valid" data-valmsg-summary="true"><ul><li style="display:none"></li>
			...
			<?php
					$this_user = $_SESSION['username'];
					 $sqluser = "SELECT * FROM members where username = '$this_user'";
...
if ($resultuser->num_rows > 0) {
    ...
    while($row = $resultuser->fetch_assoc()){
						...
						$ex_rate = $rate; // It is now dynamic
						$amount1 = $_GET['amount'];
						$amount = $amount1 * $ex_rate;
						$email = $row['email'];
						$acount = $row['id'];
						$phone = $row['phone'];
    }
    
    echo '<span style="color:green;"> Dear '. $first_name . '  ' .$last_name. ' Send Ksh. '.$amount.' as follows: </span>';
...
?>
					       ...
					       <ol>
					       <li>Click the <strong>Safaricom</strong> icon on your Phone. </li>
					       <li>Click <strong>Mpesa</strong>. </li>
					       <li>Click <strong>Lipa na Mpesa</strong>. </li>
					       <li>Click <strong>Paybill</strong> </li>
					       <li>Enter Business number as: <strong><?php echo $paybill_number; ?> <!---there is need to make this dynamic -->
					       
					       </strong> </li>
					       <li>Enter account as: <strong>
					       	<?php
        ...
        echo $phone; ?></strong>
					       ...
					       <li>Enter amount as: <strong><?php $amount = $_GET['amount']; 
					       $e_rate = $rate;
					       $amount1= $e_rate * $amount;  echo $amount1; ?></strong> </li>  
					      ...
					      <p>Your account will be credited instantly.</p> 
	<hr>   
					    
					<form action="mpesa.php?$amount1$account=$account" method="GET" name="login_form">
					    <div class="form-group row">
	<div class="column medium-6">
		<label for="buyerPassword" class="control-label"><span class="field-validation-valid" data-valmsg-for="password" data-valmsg-replace="false">*</span></label>
	...
	<div class="controls input-group">
		<input type="submit" value="Change amount" name="change" class="button alert"/>
	</div>
</div>
						</form>
