...
<form action="" class="form-horizontal" name="registration_form" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>" method="POST">

<div class="form-group">
    <label for="buyerCountry" class="control-label">
        Country</label>
	 ...
	 <option value="Afghanistan">Afghanistan</option>
		...
		<p class="help-text">Payment options vary by country and cannot be changed after registering</p>
</div>
...
<div class="form-group">
	...
	<div class="controls input-group">
		...
		<input class="input-block-level input-large" id="buyerEmail" name="email" placeholder="Your Email" type="text" value="" required/> 
	</div>
</div>

<label class="control-label" for="buyerFirstName">Your Name  <span class="field-validation-valid" data-valmsg-for="firstName" data-valmsg-replace="false">*</span></label>
<div class="form-group row">
	<div class="column medium-6">
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-user"></i></span>
		  <input class="input-block-level input-large input-group-field" id="buyerFirstName" name="FirstName" placeholder="First Name" type="text" value="" required/>
	   </div>
	</div>
	<div class="column medium-6">
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-user"></i></span>
		 <input class="input-block-level input-large input-group-field" id="buyerLastName" name="LastName" placeholder=" Last Name" type="text" required/>
	   </div>
	</div>

</div>
	<label class="control-label" for="buyerFirstName">Username and account type<span class="field-validation-valid" data-valmsg-for="firstName" data-valmsg-replace="false">*</span></label>								   
<div class="form-group row">
	<div class="column medium-6">
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-user"></i></span>
		  <input class="input-block-level input-large input-group-field" id="buyerFirstName" name="username" placeholder="Username" type="text" required/>
	   </div>
	</div>
...
<div class="form-group row">
	...
	<div class="column medium-6">
		<label for="buyerConfirmPassword" class="control-label">Confirm password <span class="field-validation-valid" data-valmsg-for="confirmPassword" data-valmsg-replace="false">*</span></label>
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-lock"></i></span>
		 <input class="input-block-level input-large  input-group-field" id="buyerConfirmPassword" name="confirmpwd" type="password" value="" />
	   </div>
	</div>
</div>
...
<div class="form-group">
	<div class="controls input-group">
		<input type="submit" value="Create Personal Account" class="button alert" 	onclick="return regformhash(this.form,
                                   this.form.username,
                                   this.form.email,
                                   this.form.password,
