...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          <legend>Mailer Params - settings</legend>
...
$sql = "SELECT * FROM mailer_params where id = 1";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo
											'<tr>
										<form method="POST" action="php/save_mailerParams.php">
											<td><input type="submit" name="save" value="Save Mailer Params" class="button special small fit"></td></tr>
											<tr>
													<td>Website name: <input type="text" name="site" value="'.$row['site_name'] . '" required></td>
												...
												<tr>
													<td>Support email: <input type="text" name="s_email" value="'.$row['support_email'] . '" required></td>
													...
													<tr>
													<td>No-Reply email: <input type="text" name="no_reply" value="'.$row['no_replt'] . '" required></td>
													...
													<tr>
													<td>Gateway url: <input type="text" name="url" value="'.$row['site_url'] . '" required></td>
													...
													<tr>
													<td>Mailer subject: <input type="text" name="subject" value="'.$row['mailer_subject'] . '" required></td>
    ...
    echo "<tr><td><p style='color:red;text-align:center;'>Please click Edit settings button above to set up.</p></td><td>";
}		
					?>
