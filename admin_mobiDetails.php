...
<head>
        ...
        <title>MOBI Details - Payment Gateway</title>
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          ...
          <legend>MOBI details <br>(<span style="color:red;">Note: System Base Currency is <?php echo $gateway_currency; ?></span>)</legend>
...
<div class="validation-summary-valid" data-valmsg-summary="true"><ul><li style="display:none"></li>
	...
	<table style="width:100%;">
						...
						$id = preg_replace('/XlAPCHF526628GSHAJ/', '', $code);
											    ...
											    $sql = "SELECT * FROM offline_MOBI where id = '$id'";
$result = $mysqli->query($sql);

if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        $MOBI_name = $row['MOBI_name'];
     ...
     if($allowed_country1 ==''){
        ...
        echo
											'
											<form action="php/process_editMOBI.php" method="POST">
													<tr>
										
											<td><input type="submit" class="button special small fit" name ="update_MOBI" value="Save '.$MOBI_name.' Changes" />
											
											<input type="hidden" class="button special small fit" name ="code" value="'.$id.'">
											</td></tr>
													
														<tr> <td>Allowed?: (yes or no) <input type="text" name = "allowed" value="'.$row['allowed'].'" /> </td></tr>
													
														<tr><td>Mobi name: <span style="color:#2B547E;">' .$row['MOBI_name']. '</span></td></tr>
														
													
													<tr><td>Exchange rate: <span style="color:#2B547E;"><input type="text" name="rate" value="' .$row['e_rate']. '"/></span></td></tr>
													
													<tr> <td>Business mobile number: <input type="text" name = "mobi_number" value="'.$row['mobi_number'].'" /> </td></tr>
													
													
												
												<tr>	<td>Allowed Currency (example: USD, KSH, TSH, USH etc): <input type="text" name="allowed_currency" value="'.$row['currency'].'" /></td></tr>
	 ...
	 <option value="Afghanistan">Afghanistan</option>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                 <option value="ALL">All Countries</option>
													...
													<tr>
											<td><input type="submit" class="button special small fit" name ="update_MOBI" value="Save '.$MOBI_name.' Changes" /></td></tr>
										</form>	
												';
    ...
    echo "<p style='color:red;text-align:center;'>No such a MOBI Payment method. </p>";
}
