...
<head>
        ...
        <title>My agency withdrawals  - Payment Gateway</title>
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          <legend>Withdrawals at my agent</legend>
...
if ($resultuser->num_rows > 0) {
    ...
    if($level !=='admin'){
											    ...
											    $sql = "SELECT * FROM transactons where recipient_name = '$id' AND transaction_type ='Withdraw' ORDER BY date DESC LIMIT 10";
$result = $mysqli->query($sql);
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo
											'<tr>
													<td><a href="singlePayment.php?code=XlAPCHF526628GSHAJ'.$id.'">'. date('d F, Y', strtotime($row['date'])) . '</td>
