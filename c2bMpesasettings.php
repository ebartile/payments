...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          <legend>C2B Mpesa settings - Payment Gateway</legend>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo
											...
											<td><a href="edit_c2bSettings.php" class="button special small fit">Edit Mpesa C2B parameters</a></td></tr>
											<tr>
												...
												<tr>
													<td>Register url: <a href="#">'.$row['register_url'] . '</a></td>
													
												
												<td>	
											<a href="c2b/Authenticate.php"target="blank"><button class="button special">Register URLs</button></a>
												</tr>	
												
													<tr>
													<td>Confirmation url: <a href="#">'.$row['confirm_url'] . '</a></td>
													...
													<tr>
													<td>Validation url: <a href="#">'.$row['validation_url'] . '</a></td>
												...
												<tr>
													<td>consumer Key: <a href="#">'.$row['consumer_key'] . '</a></td>
												...
												<tr>
													<td>Consumer secret: <a href="#">'.$row['consumer_secret'] . '</a></td>
													...
													<tr>
													<td>Ksh to USD Exchange rate: <a href="#">'.$row['e_rate'] . '</a></td>
								
												</tr>
													<tr>
													<td>Sms Notifications: <a href="#">'.$row['sms_on'] . '</a></td>
								
												</tr>
												
												
													<tr>
													<td>Security token: <a href="#">'.$row['security_token'] . '</a></td>
													
												
											<!--<td>
											Encoded Security token: <a href="#">'.$row['encoded_token'] . '</a>
											</td	
											<td>
											
											<input type ="submit" value ="Generate Token" name="generate">
