...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          <legend>Payment Method details</br>(<span style="color:red;">Note: System Base Currency is <?php echo $gateway_currency; ?></span>)
					</legend>
		...
		?>	
					...
					<table style="width:100%;">
						...
						$id = preg_replace('/XlAPCHF526628GSHAJ/', '', $code);
											    ...
											    $sql = "SELECT * FROM payment_methods where method_id = '$id'";
$result = $mysqli->query($sql);
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
     ...
     if($allowed_country1 ==''){
        ...
        echo
											'
											<form action="php/process_editMethod.php" method="POST">
													<tr>
										
											<td><input type="submit" class="button special small fit" name ="update_method" value="Save '.$method_name.' Changes" />
											
											<input type="hidden" class="button special small fit" name ="code" value="'.$id.'">
											</td></tr>
													
														<tr><td>Method name: <span style="color:#2B547E;">' .$row['method_name']. '</span></td></tr>
														
														
															<tr><td>Active: <span style="color:#2B547E;"><input type="text" name="active" value="' .$row['allowed']. '" /></span></td></tr>
													
													
													
													
													
													<tr><td>Withdrawal method: <span style="color:#2B547E;"><input type="text" name="withdraw" value="' .$row['withdrawal_method']. '"/></span></td></tr>
													
													<tr> <td>Deposit method: <input type="text" name="deposit" value="'.$row['deposit_method'].'" /> </td></tr>
													
													<tr><td>Deposit fee (%): <input type="text" name="deposit_fee" value="'.$row['deposit_fee'].'" /> </td></tr>
													
												<tr>	<td>Withdrawal fee (%): <input type="text" name="withdraw_fee" value="'.$row['withdrawal_fee'].'" /></td></tr>
	 ...
	 <option value="Afghanistan">Afghanistan</option>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                 <option value="All">All Countries</option>
													...
													<tr>
											<td><input type="submit" class="button special small fit" name ="update_method" value="Save '.$method_name.' Changes" /></td></tr>
										</form>	
												';
