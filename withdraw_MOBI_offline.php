...
<head>
        ...
        <title>Withdraw via Mobile Wallet Gateways</title>
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          ...
          <legend>Allowed Mobile Wallets Methods</legend>
...
<form  class="form-horizontal" action="php/withdraw_MOBI_final.php" method="POST" name="login_form">



<div class="form-group">
	<label class="control-label" for="buyerEmail">Select a Mobile Gateway<span class="field-validation-valid" data-valmsg-for="email" data-valmsg-replace="false">*</span></label>
	<div class="controls input-group">
		<span class="input-group-label"><i class="pe-7s-mail"></i></span>
		<select name="MOBI" id="mobi" required>
													<option value="" selected hidden>Select a Mobile Gateway </option>
												
												<?php
        
        $result = $mysqli->query("select MOBI_name, value from offline_MOBI WHERE allowed = 'yes' AND allowed_country ='$country' || allowed_country = 'ALL'");
        while ($row = $result->fetch_assoc()) {
            $MOBI_name = $row['MOBI_name'];
            $value = $row['value'];
             echo '<option value="'.$value.'">'.$MOBI_name.'</option>';
        }
        ?>
	...
	<div class="column medium-6">
		...
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-lock"></i></span>
		 	<input type="text" name="amount" id="amount" value="<?php echo $_GET['amount']; ?>" placeholder="Amount" required/>
...
<div class="form-group row">
	<div class="column medium-6">
		<label for="buyerPassword" class="control-label">Enter your mobile money number or Binitoo wallet Card Number<span class="field-validation-valid" data-valmsg-for="password" data-valmsg-replace="false">*</span></label>
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-lock"></i></span>
		 		<input type="text" name="phone" id="phone" placeholder="Enter your mobile money number" required/>
...
<div class="form-group">
	<div class="controls input-group">
		<input type="submit" value="Withdraw" name="withdraw" class="button alert"/>
	</div>
</div>
</form>
<?php
