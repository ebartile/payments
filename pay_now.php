...
<form  class="form-horizontal"action="send_confirm.php" method="GET" name="login_form">
...
<div class="form-group">
	...
	<div class="controls input-group">
		<span class="input-group-label"><i class="pe-7s-mail"></i></span>
			<input type="email" name="email" id="email" value="<? echo $_GET['business']; ?>" readonly/>
	</div>
</div>
	...
	<div class="column medium-6">
		...
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-lock"></i></span>
		 	<input type="text" name="amount" id="amount" value="<? echo $_GET['amt']; ?>" readonly/>
...
<div class="form-group">
	<div class="controls input-group">
		<input type="submit" value="Proceed" name="send" class="button alert"/>
	</div>
</div>
</form>
<?php
