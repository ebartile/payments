...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo
											...
											<td><a href="edit_bitcoinSettings.php" class="button special small fit">Edit Bitcoins parameters</a></td></tr>
											<tr>
													<td>API key: <a href="#">'.$row['api_key'] . '</a></td>
												...
												<tr>
													<td>Secret: <a href="#">'.$row['secret'] . '</a></td>
													
											
												</tr>	
												
													<tr>
													<td>My X pub: This is Hidden. Not advisable to show your X pub for security purposes. However, you will need to set it</td>
													...
													<tr>
													<td>Call back url: <a href="#">'.$row['call_back_url'] . '</a></td>
    ...
    echo "<tr><td><p style='color:red;text-align:center;'>Please click Edit settings button above to set up Bitcoin parameters.</p></td><td>";
}		
					?>
