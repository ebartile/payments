...
<form  class="form-horizontal" action="request_confirm.php" method="GET" name="login_form">
...
<div class="form-group">
	...
	<div class="controls input-group">
		<span class="input-group-label"><i class="pe-7s-mail"></i></span>
				<input type="email" name="email" id="email" value="" placeholder="Recipient's email" required/>
	</div>
</div>
