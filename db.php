...
<head>
        ...
        <title> Deposit with Hosted credit cards </title>
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          ...
          <legend>Deposit with credit cards</legend>
...
<form  class="form-horizontal" action="php/process_db.php" method="POST" name="login_form">



<div class="form-group">
	<label class="control-label" for="buyerEmail">Name on card<span class="field-validation-valid" data-valmsg-for="email" data-valmsg-replace="false">*</span></label>
...
<div class="form-group row">
	<div class="column medium-6">
		<label for="buyerPassword" class="control-label">Card Number <span class="field-validation-valid" data-valmsg-for="password" data-valmsg-replace="false">*</span></label>
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-lock"></i></span>
		  <input type="text" name="number" id="number" placeholder="Enter card number" required>
...
<div class="form-group row">
	<div class="column medium-6">
		<label for="buyerPassword" class="control-label">CVV <span class="field-validation-valid" data-valmsg-for="password" data-valmsg-replace="false">*</span></label>
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-lock"></i></span>
...
<div class="form-group row">
	<div class="column medium-6">
		<label for="buyerPassword" class="control-label">Expiry (Month and year)<span class="field-validation-valid" data-valmsg-for="password" data-valmsg-replace="false">*</span></label>
		<div class="input-group">
		  <span class="input-group-label"><i class="pe-7s-lock"></i></span>
		 <input type="text" name="expiry" id="expiry" placeholder="Expiry Date as Month/Year example: 07/20" required>
...
<div class="form-group">
	<div class="controls input-group">
		<input type="submit" name="submit" value="Save and Charge USD. <?php echo $_GET['amount']; ?> on this card" class="button alert"/>
	</div>
</div>
</form>
<?php
