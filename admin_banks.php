		...
		?>	
				...
				<table style="width:80%;">
											...
											<tr>
												...
												<th>Account names</th>
												<th>Activated?</th>
												<th> <button onclick="openForm()" class="button alert">Add a Bank</button></th>
...
$sqluser = "SELECT * FROM banks ORDER BY id DESC";
...
if ($resultuser->num_rows > 0) {
    ...
    while($row = $resultuser->fetch_assoc()) {
        ...
        echo
											'<tr>
													<td><a href="admin_bankDetails.php?code=XlAPCHF526628GSHAJ'.$row['id'].'">'.$row['bank_name'].'</a></td>
													...
													<td>'.$row['active'].'</td>
														...
														<td><button class="button alt small fit"><a href="admin_bankDetails.php?code=XlAPCHF526628GSHAJ'.$row['id'].'">Edit</a></button></td>
												</tr>';
...
<?php require_once "inc/footer.php"; ?>
  ...
  <form action="php/add_bank.php" class="form-container" method="POST">
      <button type="button" class="btn cancel" onclick="closeForm()">Close form </button>
    <p>You are now adding a new Bank</p>
