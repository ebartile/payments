...
<head>
        ...
        <title>Deposit MOBI Wallet- Payment Gateway</title>
...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          ...
          <legend>Deposit via <? echo $_GET['MOBI']; ?></legend>
...
<div class="validation-summary-valid" data-valmsg-summary="true"><ul><li style="display:none"></li>
	...
	<?php
				...
				$amount = $_GET['amount'];
					...
					$sql = "SELECT * FROM offline_MOBI where value ='$MOBI'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      $amount2 = $amount*$rate;
        echo'
        <div>Deposit money via the following details, enter the transaction reference number and submit.</div>
    <hr>
    <div>'.$MOBI.' Number: '.$row['mobi_number'].'</div>
        
           <div>Amount to pay: '.$currency.'. '.$amount2.'</div>
           <hr>
           <form action="php/process_MOBI_transactions.php" method="POST" name="login_form">
						<div class="form-group row">
	<div class="column input-group">
		<label for="buyerPassword" class="control-label">Transaction reference code <span class="field-validation-valid" data-valmsg-for="password" data-valmsg-replace="false">*</span></label>
		<div class="input-group">
									...
									<input type ="hidden" name="MOBI" value ="'.$row['MOBI_name'].'">
	...
	<div class="controls input-group">
									<input type="submit" name="submit" value="Submit"  class="button alert"/>
								</div>
							</div>
						</form>
