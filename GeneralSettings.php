...
<head>
        ...
        <title>Site settings - Payment Gateway</title>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo
											...
											<td><a href="edit_siteSettings.php" class="button special small fit">Edit Site Settings</a></td></tr>
											<tr>
													<td>Website name: <a href="#">'.$row['site_name'] . '</a></td>
												...
												<tr>
													<td>Paypal gateway Mode: <a href="#">'.$row['paypal_gateway_mode'] . '</a></td>
													...
													<tr>
													<td>Paypal email: <a href="#">'.$row['paypal_email'] . '</a></td>
													...
													<tr>
													<td>Paypal Cancel url: <a href="#">'.$row['paypal_cencel_url'] . '</a></td>
													...
													<tr>
													<td>Paypal Confirm url: <a href="#">'.$row['paypal_confirm_url'] . '</a></td>
												...
												<tr>
													<td>Gateway default currency: <a href="#">'.$row['gateway_currency'] . '</a></td>
												...
												<tr>
													<td>Gateway Currency Symbol: <a href="#">'.$row['gateway_currency_symbol'] . '</a></td>
