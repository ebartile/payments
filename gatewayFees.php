...
<div class="row">
   	<div class="column medium-7 lleft">
   	  <fieldset>
          <legend>Default Gateway Fees</br>
					</legend>
...
$sqluser = "SELECT * FROM default_gateway_fees ORDER BY id DESC";
        ...
        echo
											'<tr>
													...
													<td>'.$row['type'].'</td>
														...
														<td><button class="button alt small fit"><a href="edit_fees.php?code=XlAPCHF526628GSHAJ'.$row['id'].'">Edit</a></button></td>
												</tr>';
												
    }}else{
        echo 'No default Gateway fees set';
    }
