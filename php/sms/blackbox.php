...
class Blackbox {
	...
	public function __construct($api_key="", $api_signature="", $delivery_reports=0)
	{
		$this->api_url = "";
		$this->api_parameters = "";	
		...
		$this->delivery_reports = $delivery_reports;		
		$this->sms_messages = "";
	...
	public function queue_sms($recipient, $message, $sender = "", $keyword = "", $scheduled_date = "")
	{
		...
		$this->sms_messages .= "<keyword>" . $keyword . "</keyword>";
	...
	function execute()
	{
		...
		$this->api_url = "http://blackbox.co.ke/vas/index.php/api/" . $this->api_url; 
		$this->api_parameters = 'api_key=' . urlencode($this->api_key) . '&api_signature=' . urlencode($this->api_signature) . '&delivery_reports=' . urlencode($this->delivery_reports) . $this->api_parameters;	
